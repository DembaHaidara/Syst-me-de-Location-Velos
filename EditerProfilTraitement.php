...
$bdd = new PDO('mysql:host=127.0.0.1;dbname=haidara', 'root', '');
  ...
  $info3= Securisation($_POST['email']);
      ...
      $insert = $bdd->prepare("UPDATE inscriptionsql SET  Username = ? , Password = ? , email = ?  WHERE id = ?");
      $insert->execute(array($info0,$info2,$info3,$_SESSION['id']));
